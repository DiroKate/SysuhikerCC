...
function DevelopTabPane() {
  return (
    <div>
      ...
      <br />
      <p><LocalIcon type="guanwang" />唯一官网：<a href="http://sysuhiker.cc">http://sysuhiker.cc</a></p>
      <br />
      ...
      <Row type="flex" gutter={24}>
        <Col xs={{span:20,offset:2}} sm={{span:10,offset:0}}>
          <Card className={styles.card}>
            ...
            <p><Icon type="mail" className={styles.fontSize} /> later.h.p@qq.com</p>
            <p><Icon type="github" className={styles.fontSize} /> <a href="https://github.com/later2015/sysuhiker">later2015/sysuhiker</a></p>
        ...
        <Col xs={{span:20,offset:2}} sm={{span:10,offset:0}}>
          <Card className={styles.card}>
            ...
            <p><Icon type="mail" className={styles.fontSize} /> diroguan@foxmail.com</p>
            <p><Icon type="github" className={styles.fontSize} /> <a href="https://github.com/DiroKate/SysuhikerCC">DiroKate/SysuhikerCC</a></p>
            <p><Icon type="tags" className={styles.fontSize} />
              <Tag>Node.js</Tag>
              <Tag>Reactjs</Tag>
              <Tag>antd</Tag>
